...
```html
<!-- Minified -->
<script src="https://unpkg.com/@okiba/drag-emitter@0.1.10/dist/index.min.js"></script>

<!-- Full -->
<script src="https://unpkg.com/@okiba/drag-emitter@0.1.10/dist/index.js"></script>
```
