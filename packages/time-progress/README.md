...
```html
<!-- Minified -->
<script src="https://unpkg.com/@okiba/time-progress@1.0.3/dist/index.min.js"></script>

<!-- Full -->
<script src="https://unpkg.com/@okiba/time-progress@1.0.3/dist/index.js"></script>
```
