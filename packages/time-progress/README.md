...
```html
<!-- Minified -->
<script src="https://unpkg.com/@okiba/time-progress@1.0.18/dist/index.min.js"></script>

<!-- Full -->
<script src="https://unpkg.com/@okiba/time-progress@1.0.18/dist/index.js"></script>
```
