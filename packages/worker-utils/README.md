...
```html
<!-- Minified -->
<script src="https://unpkg.com/@okiba/worker-utils@0.1.12/dist/index.min.js"></script>

<!-- Full -->
<script src="https://unpkg.com/@okiba/worker-utils@0.1.12/dist/index.js"></script>
```
