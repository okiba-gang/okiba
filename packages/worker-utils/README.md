...
```html
<!-- Minified -->
<script src="https://unpkg.com/@okiba/worker-utils@0.1.10/dist/index.min.js"></script>

<!-- Full -->
<script src="https://unpkg.com/@okiba/worker-utils@0.1.10/dist/index.js"></script>
```
